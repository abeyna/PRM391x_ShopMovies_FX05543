...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MoviesViewHolder> {
    ...
    public MovieAdapter(Activity mActivity, Context mContext, ArrayList<Movie> mMovieList, boolean mIsFacebookLoggedIn) {
        this.mActivity = mActivity;
        this.mContext = mContext;
        this.mMovieList = mMovieList;
        this.mIsFacebookLoggedIn = mIsFacebookLoggedIn;
    }
